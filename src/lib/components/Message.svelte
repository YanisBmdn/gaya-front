...
<div class="flex justify-center w-full text-black" transition:fly={{x: -100, duration: 700}}>
	...
	>
		<div bind:this={plotDiv} class="w-md h-100 rounded-lg bg-transparent" transition:fade={{duration: 1000}}></div>
	</div>
</div>
{/if}